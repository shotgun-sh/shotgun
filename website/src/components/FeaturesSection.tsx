...
/**
 * Feature icons — inline SVGs for each feature.
...
/** Fallback icon when a feature ID has no matching icon */
 ...
 *
 * Displays 8 feature rows in a vertical list layout with
...
export function FeaturesSection({ className = "" }: FeaturesSectionProps) {
  return (
    <div className={className}>
      ...
      {/* Feature rows — max-width for readability */}
      <div className="mx-auto max-w-3xl">
        {features.map((feature) => (
          <FeatureRow
            key={feature.id}
            icon={featureIcons[feature.id] ?? <FallbackIcon />}
            title={feature.title}
